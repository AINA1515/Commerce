...
public class LigneCommande {
    ...
    public LigneCommande(Integer id, Commande commande, Produit produit, Integer quantite,
            StatusLigneCommande statusLigneCommande, Double montantPayee, Double prix) {
        this.id = id;
